...
CREATE TABLE public.students1 (
	id serial4 NOT NULL,
	"name" varchar(50) NOT NULL,
	email varchar(50) NOT NULL,
	"password" varchar(50) NOT NULL,
	created_on timestamp NOT NULL,
	CONSTRAINT students1_email_key UNIQUE (email),
	CONSTRAINT students1_pkey PRIMARY KEY (id)
);
...
select name from students where created_on  = '2020-10-03 00:00:00' or created_on  = '2021-05-19 00:00:00' or created_on  = '22021-03-26 00:00:00';
...
select max(id) as MinID from students;
